...
const App = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-100 font-sans text-gray-800 antialiased">
            ...
            <nav className="bg-gradient-to-r from-yellow-400 to-yellow-500 shadow-md sticky top-0 z-[60]">
                <div className="container mx-auto px-4 py-4 flex flex-col md:flex-row justify-between items-center">
                    <div className="flex items-center space-x-3 cursor-pointer" onClick={() => handleNavigation('home')}>
                        <div>
                            <YucaguiaIcon />
                        </div>
                        <span className="text-2xl font-bold" style={{ color: '#3483FA' }}>Yucaguia</span>
                    </div>
